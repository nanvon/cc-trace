...
export default {
  ...
  main: {
    ...
    noValue: "—",
    tokenBreakdownPanel: "Token breakdown",
    fastTokens: "Fast tokens",
    billingEquivalentTokens: "Billing-equivalent tokens",
    fastMultiplier: "Fast multiplier",
    fastEstimatedCost: "Fast estimated cost",
    fastShare: "Fast share",
    range: {
      today: "Today",
      yesterday: "Yesterday",
      thisWeek: "This week",
  ...
  conversations: {
    ...
    idCopied: "Copied",
    selectConversationHint: "Select a conversation on the left to see details.",
    models: "Models",
  },
  ...
  a11y: {
    ...
    usageChart: "Daily usage by provider",
