...
- 设计文档的旧注释已随 2026-08-08 `f595115` 清理：当前实现用四个一级图标（refresh → stats → settings → power），kebab/footer 已移除。**代码已确认**。
...
路径：`CCBarApp.swift`、`Main/MainWindowRootView.swift`。当前 Scene 默认尺寸为 1600×1100（2026-08-08 由 1280×680 调整）；根视图最小尺寸为 1040×520。**代码已确认**。
...
- 设计文档列出的 8 variant、位置选择器、透明度等描述已随 2026-08-08 `f595115` 删除，当前 Settings 没有对应字段。**代码已确认**。
